...
public class MenuItemsXMLPullParser {
    ...
    throws XmlPullParserException, IOException, SlickException
    {
		...
		do{
			if(eventType == XmlPullParser.START_DOCUMENT) {
				System.out.println("XML Parsing Begun: "+Utility.getDateTime());
			} else if(eventType == XmlPullParser.START_TAG) {
				processStartElement(xpp);
		}
			eventType = xpp.next();
		}while(eventType != XmlPullParser.END_DOCUMENT);
		System.out.println("XML Parsing Finished: "+Utility.getDateTime());
    }
	...
	public void processStartElement(XmlPullParser xpp) throws SlickException{
		...
		if (xpp.getName().equalsIgnoreCase("Menu")){
			...
			System.out.println("Menu System: "+xpp.getAttributeValue(null, "systemName"));
			...
			if (xpp.getAttributeValue(null, "type").equals("subImage")){
				...
				System.out.println("Added font:" + xpp.getAttributeValue(null,"name"));
			}else{
